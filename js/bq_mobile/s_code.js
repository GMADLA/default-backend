...
// var s_account="gmadonedollarglobeinsurance"
...
/* Plugin Example: manageQueryParam v1.0 */
	if(s.getQueryParam('s_kwcid'))
  	s.pageURL=s.manageQueryParam('s_kwcid',1,1); // swap and encode for SearchCenter

/* Plugin Example: clickThruQuality v0.8 */
//  s.clickThruQuality('s_kwcid','event8','event9')
...
s.visitorNamespace="gmad"
s.trackingServer="gmad.112.2o7.net"
